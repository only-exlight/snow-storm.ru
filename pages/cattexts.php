...
$Page = $_GET['page'];
$query ="SELECT name, description, date, id FROM art WHERE category = 'texts'"; // текст запроса
...
<a class="curr" href="#cattexts/1">Стихи/Текста</a>
<hr>';
